"""
Core Services Coverage Testing Suite for Fertilizer Application Service
...
# Import core service modules that are working
...
class TestDataFactory:
    ...
    def create_equipment_specification() -> List[EquipmentSpecification]:
        ...
        return [
            EquipmentSpecification(
                ...
                application_rate_range={"min": 50.0, "max": 500.0},
                fuel_efficiency=2.5,
            ...
            EquipmentSpecification(
                ...
                fuel_efficiency=3.0,
                maintenance_cost_per_hour=35.0
            )
        ]
    ...
    def create_application_request() -> ApplicationRequest:
        ...
        return ApplicationRequest(
            ...
            application_goals=["minimize_runoff", "reduce_volatilization"],
            constraints={"max_cost_per_acre": 50.0, "application_window_days": 7},
            budget_limit=5000.0
        )


class TestApplicationMethodServiceCoreCoverage:
    """Comprehensive tests for ApplicationMethodService core functionality."""
    ...
    async def test_service_initialization_and_methods(self, service):
        ...
        assert hasattr(service, '_perform_cost_comparison')
        assert hasattr(service, '_generate_efficiency_analysis')
        assert hasattr(service, '_generate_equipment_compatibility')
    
    @pytest.mark.asyncio
    async def test_field_conditions_analysis_comprehensive(self, service, test_request):
    ...
    @pytest.mark.asyncio
    async def test_crop_requirements_analysis_comprehensive(self, service, test_request):
    ...
    @pytest.mark.asyncio
    async def test_fertilizer_specification_analysis_comprehensive(self, service, test_request):
    ...
    @pytest.mark.asyncio
    async def test_equipment_analysis_comprehensive(self, service, test_request):
    ...
    @pytest.mark.asyncio
    async def test_method_scoring_comprehensive(self, service, test_request):
    ...
    @pytest.mark.asyncio
    async def test_recommendation_generation_comprehensive(self, service, test_request):
    ...
    @pytest.mark.asyncio
    async def test_cost_comparison_comprehensive(self, service, test_request):
        """Test cost comparison with comprehensive coverage."""
        # Create mock ApplicationMethod objects
        ...
        recommendations = [
            ApplicationMethod(
                ...
                pros=["fast", "simple"],
                cons=["less precise"],
                suitability_factors=["large_fields"],
                cost_breakdown={"fertilizer": 20.0, "equipment": 5.0}
            ),
            ApplicationMethod(
                method_id="method2",
                ...
                application_timing="side_dress",
                pros=["precise", "efficient"],
                cons=["complex", "expensive"],
                suitability_factors=["small_fields"],
                cost_breakdown={"fertilizer": 25.0, "equipment": 10.0}
            )
        ]
        
        cost_comparison = await service._perform_cost_comparison(recommendations)
        assert cost_comparison is not None
        assert isinstance(cost_comparison, dict)
    
    @pytest.mark.asyncio
    async def test_input_validation_comprehensive(self, service):
        """Test input validation with comprehensive coverage."""
        # Test valid inputs
        valid_request = TestDataFactory.create_application_request()
        # Test that the service can handle valid requests
        response = await service.select_application_methods(valid_request)
        assert response is not None
        
        # Test invalid inputs - the service should handle gracefully
        ...
        try:
            ...
            # Should either return response or raise exception
    ...
    @pytest.mark.asyncio
    async def test_processing_metrics_comprehensive(self, service, test_request):
        """Test processing metrics logging with comprehensive coverage."""
        start_time = time.time()
        
        # Test that the service processes requests and tracks timing
    ...
    @pytest.mark.asyncio
    async def test_complete_workflow_comprehensive(self, service, test_request):
...
class TestEquipmentAssessmentServiceCoreCoverage:
    """Comprehensive tests for EquipmentAssessmentService core functionality."""
    ...
    @pytest.mark.asyncio
    async def test_equipment_compatibility_assessment_comprehensive(self, service, test_equipment):
    ...
    @pytest.mark.asyncio
    async def test_application_efficiency_calculation_comprehensive(self, service, test_equipment):
    ...
    @pytest.mark.asyncio
    async def test_operational_cost_estimation_comprehensive(self, service, test_equipment):
    ...
    @pytest.mark.asyncio
    async def test_precision_capabilities_evaluation_comprehensive(self, service, test_equipment):
    ...
    @pytest.mark.asyncio
    async def test_maintenance_requirements_assessment_comprehensive(self, service, test_equipment):
    ...
    @pytest.mark.asyncio
    async def test_fuel_consumption_calculation_comprehensive(self, service, test_equipment):
    ...
    @pytest.mark.asyncio
    async def test_operator_skill_requirements_evaluation_comprehensive(self, service, test_equipment):
...
class TestCostAnalysisServiceCoreCoverage:
    """Comprehensive tests for CostAnalysisService core functionality."""
    ...
    @pytest.mark.asyncio
    async def test_total_cost_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_cost_per_acre_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_method_cost_comparison_comprehensive(self, service):
    ...
    @pytest.mark.asyncio
    async def test_fertilizer_costs_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_equipment_costs_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_labor_costs_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_fuel_costs_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_maintenance_costs_calculation_comprehensive(self, service, test_scenario):
    ...
    @pytest.mark.asyncio
    async def test_depreciation_costs_calculation_comprehensive(self, service, test_scenario):
...
class TestDecisionSupportServiceCoreCoverage:
    """Comprehensive tests for DecisionSupportService core functionality."""
    ...
    @pytest.mark.asyncio
    async def test_scenario_analysis_comprehensive(self, service, test_scenarios):
    ...
    @pytest.mark.asyncio
    async def test_decision_tree_generation_comprehensive(self, service):
    ...
    @pytest.mark.asyncio
    async def test_sensitivity_analysis_comprehensive(self, service):
    ...
    @pytest.mark.asyncio
    async def test_decision_criteria_evaluation_comprehensive(self, service):
    ...
    @pytest.mark.asyncio
    async def test_decision_weights_calculation_comprehensive(self, service):
    ...
    @pytest.mark.asyncio
    async def test_alternatives_ranking_comprehensive(self, service):
    ...
    @pytest.mark.asyncio
    async def test_recommendations_generation_comprehensive(self, service):
...
class TestAPIEndpointsCoreCoverage:
    ...
    def test_application_methods_endpoint_comprehensive(self, client):
    ...
    def test_equipment_assessment_endpoint_comprehensive(self, client):
    ...
    def test_cost_analysis_endpoint_comprehensive(self, client):
    ...
    def test_guidance_endpoint_comprehensive(self, client):
...
class TestPerformanceAndLoadCoreCoverage:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_request_handling_comprehensive(self, service, test_requests):
    ...
    @pytest.mark.asyncio
    async def test_memory_usage_comprehensive(self, service, test_requests):
    ...
    @pytest.mark.asyncio
    async def test_response_time_consistency_comprehensive(self, service, test_requests):
