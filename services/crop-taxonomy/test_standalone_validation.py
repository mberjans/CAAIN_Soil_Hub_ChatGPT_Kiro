#!/usr/bin/env python3
"""
Standalone test for agricultural validation service.

This test runs independently without complex imports to verify the agricultural validation system.
"""
...
from services.standalone_agricultural_validation_service import (
    StandaloneAgriculturalValidationService, VarietyRecommendation, VarietyRecommendationRequest
)
