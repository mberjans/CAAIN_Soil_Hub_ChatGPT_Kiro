"""
Simple Agricultural Intelligence API Tests
Autonomous Farm Advisory System
Version: 1.0
Date: December 2024

Simple test suite for agricultural intelligence API endpoints without full app dependencies.
"""
...
from agricultural_intelligence_routes import router
...
class TestAgriculturalIntelligenceSimpleAPI:
    """Simple test suite for agricultural intelligence API endpoints."""
    ...
    async def test_get_location_intelligence_success(self, client, sample_intelligence_response):
        ...
        with patch('agricultural_intelligence_routes.intelligence_service.get_location_intelligence') as mock_service:
    ...
    async def test_service_error_handling(self, client):
        ...
        with patch('agricultural_intelligence_routes.intelligence_service.get_location_intelligence') as mock_service:
            ...
            assert data["detail"]["error"] == "INTELLIGENCE_SERVICE_ERROR"
            assert "agricultural_context" in data["detail"]
            assert "suggested_actions" in data["detail"]
